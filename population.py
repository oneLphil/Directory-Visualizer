...
class PopulationTree(AbstractTree):
    ...
    def get_separator(self):
        ...
        representation of a path from the tree world  to a country.
        ...
        if self._parent_tree is None:
            ...
            return self._parent_tree.get_separator() + ' -> ' + name
    ...
    for region in regions:
        ...
        for country in regions[region]:
            if country in country_populations:
                ...
                current_country_tree = PopulationTree(False, country,
                                                      [], population)
                country_trees.append(current_country_tree)
        region_tree = PopulationTree(False, region, country_trees)
